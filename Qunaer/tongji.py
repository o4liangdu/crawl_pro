...
'''
excludes={"markText","地方","可以","一个","我们","很多","就是","还是","这里","感觉","没有","但是","比较","真的","还有","所以","时间","不过","因为","这个","什么","时候","非常","喜欢"}
txt=open("guangdonghuizhou.json","r").read()
txt2=open("guangdonghuizhou.txt","w", encoding='utf8')
